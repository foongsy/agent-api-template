...
class TestAPIEndToEnd:
    ...
    def test_complete_api_workflow(self, client, test_image_bytes):
        ...
        with agent_service.agent.override(model=TestModel()):
            ...
            embedding_response = client.post(
                "/api/v1/embeddings", json={"text": "This is a test text for embedding"}
            )
    ...
    def test_api_endpoints_consistency(self, client):
        ...
        with agent_service.agent.override(model=TestModel()):
            ...
            embedding_response = client.post(
                "/api/v1/embeddings", json={"text": "Test text"}
            )
            assert embedding_response.status_code == 200
            embedding_data = embedding_response.json()
    ...
    def test_processing_time_consistency(self, client):
        ...
        with agent_service.agent.override(model=TestModel()):
            ...
            embedding_response = client.post(
                "/api/v1/embeddings", json={"text": "Test text for processing time"}
            )
            assert embedding_response.status_code == 200
            embedding_data = embedding_response.json()
    ...
    def test_concurrent_requests(self, client):
        ...
        def make_embedding_request():
            return client.post(
                "/api/v1/embeddings", json={"text": "Concurrent test text"}
            )
    ...
    def test_large_text_handling(self, client):
        ...
        with agent_service.agent.override(model=TestModel()):
            ...
            embedding_response = client.post(
                "/api/v1/embeddings", json={"text": large_text}
            )
            assert embedding_response.status_code == 200

            # Test agent chat with large text
            chat_response = client.post(
                "/api/v1/agent/chat", data={"message": large_text}, files={}
            )
            assert chat_response.status_code == 200
    ...
    def test_session_management_workflow(self, client):
        ...
        with agent_service.agent.override(model=TestModel()):
            ...
            response2 = client.post(
                "/api/v1/agent/chat",
                data={"message": "This is my second message", "session_id": session_id},
                files={},
            )
    ...
    def test_error_recovery_workflow(self, client):
        ...
        with agent_service.agent.override(model=TestModel()):
            ...
            valid_response = client.post(
                "/api/v1/agent/chat", data={"message": "Valid message"}, files={}
            )
            ...
            recovery_response = client.post(
                "/api/v1/agent/chat", data={"message": "Recovery message"}, files={}
            )
    ...
    def test_api_versioning_consistency(self, client):
        ...
        endpoints = ["/api/v1/health", "/api/v1/embeddings", "/api/v1/agent/chat"]
