...
class ChatRequest(BaseModel):
    ...
    images: Optional[List[bytes]] = Field(None, description="List of image bytes (JPEG, PNG, GIF)")
    image_mime_types: Optional[List[str]] = Field(None, description="MIME types for each image")
    session_id: Optional[str] = Field(None, description="Session identifier (for future use)")
